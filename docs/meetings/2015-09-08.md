...
1. Objectives review (5 min)
 ...
 1. Phase 1 Releases roadmap
 1. Initial Implementation tasks allocation
1. Methodology and Continuous Integration environment with Github, [Jenkins](http://jenkins-ci.org/) and [Karma](http://karma-runner.github.io/0.13/index.html).
 1. PTIN presentation and demo
 1. Quobis presentation (demo?)
 1. others?
 1. discussion and methodology draft. 
