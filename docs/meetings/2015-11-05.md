 ...
 * policy engine (INESC): depends on policy language definition from wp2. Not much progress. 
 * identity module (Orange/INESC): INESC take responsability and schedule 
