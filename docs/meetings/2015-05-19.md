...
SOTA work is progressing very well (~17 references) but not yet finalised. DT offered to also contribute on Firefox OS. Contributions about Kurento and Node.js are also still missing.
...
The Selection of solutions should take into account its usability in WP6 trials.
