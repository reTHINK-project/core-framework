...
#####Hyperty Resource Data Model Used to model Resources shared such as audio, video, files, chat etc. for Communicator type Hyperties* `resourceType` String representation of CHAT|AUDIO|VIDEO|AV|SCREEN|FILE|MIDI* `direction`String representation of IN|OUT|INOUT
