...
User connection to Node.js connectors can be authentified on the Node.js module.
Socket.io integrate a way to authenticate incoming request, authenication component will have to be develop on Node.js connectors.
...
For a complete session management on Node.js, it will be interesting to use express which is a Web framework for Node.js :
http://expressjs.com/
