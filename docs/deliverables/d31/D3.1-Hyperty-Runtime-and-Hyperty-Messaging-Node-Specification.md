...
@enduml
-->
![Figure @runtime-arch-new: Runtime Architecture](Runtime_Architecture_new.png)

Fig. @runtime-arch-new
...
Fig. @runtime-security-analysis-security-browser
...
Fig. @runtime-h2h-comm-intra-comm-1-alice-invites-bob
...
Fig. @runtime-ident-man-user-registration
...
Fig. @runtime-ident-man-preprare-discovery

### Use Discovery

![Figure @runtime-ident-man-use-discovery: Use Discovery](use_discovery.png)

Fig. @runtime-ident-man-use-discovery
...
Fig. @runtime-ident-man-domain-login
...
Fig. @runtime-ident-man-user-to-hyperty-binding-scheme
...
Fig. @runtime-ident-man-user-identity-assertion-diagram
...
Fig. @runtime-m2m-intra-comm-4-pub-sub-1
...
Fig. @runtime-m2m-intra-comm-4-pub-sub-2
...
Fig. @runtime-m2m-intra-comm-4-pub-sub-3
...
Possible Strategies: \* Browser Extensions \* Docker+Node.js \*
Docker+JDK8 \* Node.js \* JDK8 \* JavaScript shim layer to be used in
...
Fig. @runtime-browser-implementation
...
Fig. @stand-runtime-cordova-archi
...
Node.js is considered one of the options for implementing the Runtime API
...
A package for LWM2M is already available for Node.js
...
Fig. @msg-node-architecture-messaging-node-architecture
...
connectors, Here is a quick architecture :
      ...
      User A ---- Node.js 1 ----- REdis ------ Node.js Connector to IdM
      User B -------|            |   |------- Node.js Connector to another CSP
                                 |   |------- Node.js Connector to Kurento
      User C -----Node.js 2 ------|   |------- Node.js Connector to an IMS GW

Communication between Users and Node.js can be managed by socket.io

Communication between Node.js and Redis can be managed by a NodesJs Redis
client module : https://github.com/NodeRedis/node\_redis

Communication between the differents Node.js instance can be managed by
...
This section attempts to match the functional blocks of the Messaging Node
